...
CREATE TABLE public.produto (
	produto_id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
...
CREATE INDEX idx_produto_produto_id ON public.produto USING btree (produto_id);
...
CREATE INDEX idx_categoria_cardapio_card_id ON public.categoria_cardapio (card_id int4_ops);
CREATE INDEX idx_categoria_cardapio_cat_id ON public.categoria_cardapio USING btree (cat_id);
